...
class AttU_Net_plus(nn.Module):
    def __init__(self, n_channels=1, n_classes=1, scale_factor=1):
        ...
        self.Conv_pooing_1 = nn.Conv2d(filters[0], filters[0], kernel_size=2, stride=2, padding=0)
        self.Conv_pooing_2 = nn.Conv2d(filters[1], filters[1], kernel_size=2, stride=2, padding=0)
        self.Conv_pooing_3 = nn.Conv2d(filters[2], filters[2], kernel_size=2, stride=2, padding=0)
        self.Conv_pooing_4 = nn.Conv2d(filters[3], filters[3], kernel_size=2, stride=2, padding=0)
